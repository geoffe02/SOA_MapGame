...
class MonstersControllerTest < ActionController::TestCase
  ...
  test "should create monster" do
    assert_difference('Monster.count') do
      post :create, monster: { description: @monster.description, location: @monster.location, name: @monster.name, strength: @monster.strength }
    end
  ...
  test "should update monster" do
    patch :update, id: @monster, monster: { description: @monster.description, location: @monster.location, name: @monster.name, strength: @monster.strength }
    assert_redirected_to monster_path(assigns(:monster))
  end
